...
/* harmony default export */ var MeetupDetail = (MeetupDetai);
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://mongodbuser1:cZOE1IRc8dCBI3kw@cluster0.l0epl.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
